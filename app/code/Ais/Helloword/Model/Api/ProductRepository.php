<?php
namespace Ais\Helloword\Model\Api;
use Ais\Helloword\Api\ProductRepositoryInterface;
use Ais\Helloword\Api\RequestItemInterfaceFactory;
use Ais\Helloword\Api\ResponseItemInterfaceFactory;
